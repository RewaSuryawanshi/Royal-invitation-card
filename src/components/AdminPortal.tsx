      ...
      <header className="bg-stone-900 text-stone-100 border-b border-stone-800 sticky top-0 z-20 shadow-md">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-tr from-amber-600 to-amber-400 flex items-center justify-center text-stone-950 font-serif font-bold text-base sm:text-lg shadow-sm shrink-0">
              👑
            </div>
            <div>
              <h1 className="font-serif text-base sm:text-lg font-bold tracking-tight text-white leading-tight truncate max-w-[130px] xs:max-w-[200px] sm:max-w-none">
                Creator Portal
              </h1>
              <div className="flex items-center gap-1 text-[11px] sm:text-xs text-amber-300/90">
                <Shield className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                <span className="hidden xs:inline">Isolated Portal Account</span>
                <span className="xs:hidden">Private Account</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            <button
              ...
              className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-full bg-stone-900 hover:bg-amber-950/80 border border-amber-500/40 text-[11px] text-amber-200 transition-all cursor-pointer disabled:opacity-50"
            ...
            >
              ...
              <span className="hidden sm:inline">{isSyncingFirebase ? 'Syncing...' : 'Push to Firestore'}</span>
              <span className="sm:hidden">{isSyncingFirebase ? '...' : 'Sync'}</span>
            </button>

            <button
              type="button"
              onClick={onOpenAuth}
              className="flex items-center gap-1.5 sm:gap-2.5 px-2.5 sm:px-3 py-1.5 rounded-full bg-stone-800 hover:bg-stone-700 border border-stone-700 text-xs text-stone-200 transition-all cursor-pointer group"
            ...
            >
              <img
                ...
                className="w-5 h-5 sm:w-6 sm:h-6 rounded-full object-cover border border-amber-400/50"
              />
              <span className="font-medium group-hover:text-amber-300 transition-colors hidden sm:inline max-w-[100px] truncate">
                {currentUser.name}
              </span>
              <span className="text-[10px] bg-amber-950/80 text-amber-300 border border-amber-500/40 px-1.5 py-0.5 rounded hidden xs:inline">
                My Account
              </span>
            </button>
